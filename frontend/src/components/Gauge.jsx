...
export default function Gauge({ value, min, max, color, unit }) {
  ...
  const [nx, ny] = toXY(angle, 30);
  return (
    <svg viewBox="0 0 100 70" style={{ width: "100%", maxWidth: 140 }}>
      <path d={arcPath(38, -140, 140)} fill="none" stroke="rgba(255,255,255,0.07)" strokeWidth="7" strokeLinecap="round" />
      <path d={arcPath(38, -140, angle)} fill="none" stroke={color} strokeWidth="7" strokeLinecap="round" />
